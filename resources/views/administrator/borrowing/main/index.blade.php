    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="alert alert-warning" role="alert">
          ...
          Setiap data peminjaman dari pegawai petugas wajib melakukan validasi dengan menekan tombol
          validasi
          ...
          komoditas yang dipinjam telah dikembalikan oleh pegawai tersebut.
